...
| `sha`    | A comma separated list of commit SHAs to generate the summary for. See [this StackOverflow post](https://stackoverflow.com/questions/63584999/list-commits-on-a-pull-request) for details on getting SHAs associated with PRs. | No        | `${{ github.sha }}`                                                                                                                                                            |

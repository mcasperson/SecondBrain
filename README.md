...
| `model`        | The model to used to answer the prompt. Note that using a custom model will slow down the action as the model must be downloaded first.                                                                                                                                           | No        | `qwen2.5-coder`                                                                                                                                                                |
| `gitDiffModel` | The model to used to summarize the git diffs. Note that using a custom model will slow down the action as the model must be downloaded first.                                                                                                                                     | No        | `llama3.2`                                                                                                                                                                     |
